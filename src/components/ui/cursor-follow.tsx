...
const CursorFollow: React.FC<CursorFollowProps> = ({
  ...
  // Calculate bubble width and height (adding 34px to account for the Eye icon + tighter padding)
  const bubbleWidth = cursorText ? Math.max(textWidth + 34, 44) : CIRCLE_SIZE
  const bubbleHeight = cursorText ? 32 : CIRCLE_SIZE
